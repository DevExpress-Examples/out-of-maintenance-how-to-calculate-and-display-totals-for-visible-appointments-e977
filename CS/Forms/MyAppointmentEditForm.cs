...
namespace CalculateTotals {
	...
	public class MyAppointmentFormController : AppointmentFormController {
        ...
        public decimal CustomPrice {
            get
            {
                if (EditedAppointmentCopy.CustomFields["CustomPrice"] != DBNull.Value && EditedAppointmentCopy.CustomFields["CustomPrice"] != null)
                {
                    return (decimal)EditedAppointmentCopy.CustomFields["CustomPrice"];
                }
                return 0;
            }
            set { EditedAppointmentCopy.CustomFields["CustomPrice"] = value; } }
